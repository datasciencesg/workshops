...
We at Data Science Singapore believe in self-learning. In the Data Science (DS) or Machine Learning (ML) field, most often the best knowledge you get is learnt from authentic conferences, unversity materials, open source documentations/forums and a tonne of resources online that are freely available. We put up these materials to help individuals understand what's needed for DataScience and they can use this free knowledge gained to choose suitable workshops / learning paths for themselves.
